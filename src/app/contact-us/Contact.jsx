    ...
    <>
      <section className="relative w-full h-62 md:h-88 flex items-center justify-center text-white">
        ...
        <div className="relative z-10 flex flex-col items-center text-center px-4">
          ...
          {/* Title */}
          <h1 className="text-2xl md:text-5xl font-bold mb-2">Contact Us</h1>
        </div>
      </section>
          ...
          >
            {[
              ...
              },
              {
                ...
                content: [
                  "👤 Saurabh Sharma",
                  "📞 +91 9289713130 (7 PM to 9 AM )",

                  "",
                  "",
                  "👤 Neha Bisht",
                  "📞 +91 8796177844 (10 AM to 7 PM)",
                ],
              },
              {
                icon: MapPin,
              ...
              return (
                ...
                >
                  ...
                  {item.content.map((text, idx) => (
                    <p
                      key={idx}
                      className="text-sm opacity-80 mb-1 group-hover:opacity-100 transition"
                    >
                      {text}
                    </p>
                  ))}
