...
import { User, Phone, ShoppingCart, Cross, Landmark } from "lucide-react";
...
export default function Navbar() {
  ...
  return (
    <div className="w-full bg-black figtrees text-white border-b border-gray-400 shadow-md sticky top-0 z-48">
      {/* Top Bar */}
      <div className="bg-[#111] hidden lg:block border-b py-2 border-gray-700">
        <div className="max-w-full mx-3 px-4 md:px-2 h-11 flex items-center justify-between">
          {/* GST */}
          <div className="flex items-center gap-2 text-sm text-white">
            <ReceiptText size={20} className="text-[#a87561]" />
