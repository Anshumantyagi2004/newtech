    ...
    <div className="w-full bg-black figtrees text-white border-b border-gray-400 shadow-md sticky top-0 z-40">
      <div className="h-18 flex items-center justify-between px-2 md:px-6">
        ...
        <div className="flex items-center md:gap-3 gap-1">
          ...
          <Link href={"/categories"} className="hidden md:flex justify-center items-center bg-[#c2907b] px-2 py-1.5   hover:scale-105 duration-150 transition-all font-light">Our Products</Link>
        </div>
