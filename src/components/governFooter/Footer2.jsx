...
<p className="flex items-center gap-2">
  <Mail size={14} />
  <a
    href="mailto:rajiv.arora@nvsledwall.com"
    className="hover:text-[#915946]  transition-colors"
  >
    rajiv.arora@nvsledwall.com
  </a> 
</p>
<p className="flex items-center gap-2">
  <Mail size={14} />
  <a
    href="mailto:ashish.khurana@nvsledwall.com"
    className="hover:text-[#915946]  transition-colors"
  >
    ashish.khurana@nvsledwall.com
