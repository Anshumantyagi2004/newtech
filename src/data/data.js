...
export const categories = [
  ...
  },
  {
    ...
    metaTitle:
      "Outdoor Advertising LED Display Screens | LED Video Wall Manufacturer | Newtech Video Systems",
    metaDescription:
...
export const products = [
  ...
  // },
  {
    ...
    metaTitle:
      "Vivid LED Display | High-Brightness LED Video Wall Screens | Newtech Video Systems",
    metaDescription:
      "Newtech Video Systems Pvt. Ltd. offers Vivid LED displays for vibrant, high-brightness visuals. Ideal for advertising, events, retail branding & digital signage applications.",
    catId: "indoor-advertising-led-displays",
    catName: "Indoor Advertising LED Displays",
    ...
    specs: {
      Common: {
        interfaces:
          "HDMI ×2 (in), HDMI ×1 (out), USB ×3, LAN ×1, WiFi, Infrared, Bluetooth, Built-in Speakers 15W ×2",
        touch: "10-point infrared touch",
        ...
        ipRating: "IP65 (Front)",
        system: "Android Cortex A73 + A53 (Quad-Core CPU), 4GB RAM, 256GB SSD",
        accessories: "HDMI cable ×1, Wireless Screen Mirroring Adapter ×1",
        optional: "Mobile Stand, Base, Omnidirectional Microphone, Camera",
        installation: "Mounting / Mobile Stand / Base",
        certifications: "CCC, HDR3.0, CB, CE, FCC, ETL, Energy Efficiency",
      },

      "108inch": {
        size: "2410 × 1500 × 35 mm",
        resolution: "1920 × 1080",
        displayType: "2K Micro LED Direct View",
      },

      "135inch": {
        size: "3010 × 1840 × 35 mm",
        resolution: "1920 × 1080",
        displayType: "2K Micro LED Direct View",
      },
  ...
  },
  {
    ...
    overview: [
      ...
      "Supports creative installations with flexible design adaptability, making it perfect for innovative and visually engaging display concepts",
    ],

    features: [
      "Up to 80% Transparency allows natural light flow and clear visibility through the screen, making it ideal for glass installations and modern architecture",
      "IP65 Protection Rating ensures resistance against dust and water, making it suitable for both indoor and outdoor environments",
      "Flexible Curvature (-15° to +15°) enables creative curved installations, allowing unique and customized LED wall display designs",
      "Lightweight and modular structure simplifies installation while maintaining strong durability and stability",
      "Delivers bright, clear visuals with consistent color performance, ensuring effective communication without compromising transparency",
    ],
    ...
    specs: {
      ...
      ledType: "3-in-1 SMD",
      brightness: "2000/4000 nits",
      pixelsPerPanel: "256 × 64",
      pixelDensity: "32,768 dots/m²",
      panelWeight: "6.5 kg",
      moduleSize: "1000 × 500 × 80 mm",
  ...
  },
  {
    ...
    applicationIds: ["reception-and-lobby-areas", "rental"],
    metaTitle:
      "Elite Series | Digital Advertising LED Display Screen | Newtech Video Systems",
    metaDescription:
  ...
  // },
  {
    ...
    id: "nvs-400",
    metaTitle:
      "NVS 400 | LED Video Wall Controller System | Newtech Video Systems",
    metaDescription:
      "Newtech Video Systems Pvt. Ltd. offers NVS 400 for advanced video wall control. High-performance controllers and accessories for LED display systems.",
    catId: "accessories-and-controllers",
    catName: "Accessories & Controllers",
    ...
    overview: [
      "NVS 400 is a powerful all-in-one advertising LED display screen controller that combines advanced video processing and control functionalities into a single, efficient device",
  ...
  // },
  {
    ...
    metaTitle:
      "NVS 600 | Advanced LED Controller System | Newtech Video Systems",
    metaDescription:
  ...
  },
  {
    ...
    metaTitle:
      "NVS 1000 | Advanced LED Video Wall Controller | Newtech Video Systems",
    metaDescription:
      "Newtech Video Systems Pvt. Ltd. offers NVS 1000 for high-performance video wall control. Advanced LED controller system for seamless display management.",
    catId: "accessories-and-controllers",
    catName: "Accessories & Controllers",
  ...
  },
  {
    ...
    specs: {
      ...
      ipRating: "IP20",
      systemSoftware:
        "Android 11.0 OS, Android terminal application software, FPGA program",
  ...
  // },
  {
    ...
    catId: "accessories-and-controllers",
    catName: "Accessories & Controllers",
    img: "/ProductImages/_DSC04392.webp",
...
export const serviceLocations = [
  ...
  {
    href: "/advertising-led-display-in-chandigarh",
    label: "Chandigarh",
    id: 17,
  },
  { href: "/advertising-led-display-in-kochi", label: "Kochi", id: 18 },
  {
    href: "/advertising-led-display-in-coimbatore",
    label: "Coimbatore",
    id: 19,
  },
  {
    href: "/advertising-led-display-in-visakhapatnam",
    label: "Visakhapatnam",
    id: 20,
  },
  ...
  {
    href: "/advertising-led-display-in-bhubaneswar",
    label: "Bhubaneswar",
    id: 41,
  },
  ...
  {
    href: "/advertising-led-display-in-thiruvananthapuram",
  ...
  {
    href: "/advertising-led-display-in-tiruchirappalli",
  ...
  {
    href: "/advertising-led-display-in-tirunelveli",
    label: "Tirunelveli",
    id: 56,
  },
  {
    href: "/advertising-led-display-in-vijayawada",
    label: "Vijayawada",
    id: 57,
  },
  ...
  {
    href: "/advertising-led-display-in-karimnagar",
    label: "Karimnagar",
    id: 62,
  },
  { href: "/advertising-led-display-in-nizamabad", label: "Nizamabad", id: 63 },
  {
    href: "/advertising-led-display-in-aurangabad",
    label: "Aurangabad",
    id: 64,
  },
  ...
  {
    href: "/advertising-led-display-in-saharanpur",
    label: "Saharanpur",
    id: 72,
  },
  ...
  {
    href: "/advertising-led-display-in-muzaffarpur",
    label: "Muzaffarpur",
    id: 75,
  },
  { href: "/advertising-led-display-in-bhagalpur", label: "Bhagalpur", id: 76 },
  {
    href: "/advertising-led-display-in-jamshedpur",
    label: "Jamshedpur",
    id: 77,
  },
  ...
  {
    href: "/advertising-led-display-in-dharamshala",
    label: "Dharamshala",
    id: 87,
  },
  ...
  {
    href: "/advertising-led-display-in-maharashtra",
    label: "Maharashtra",
    id: 101,
  },
  {
    href: "/advertising-led-display-in-uttar-pradesh",
    label: "Uttar Pradesh",
    id: 102,
  },
  {
    href: "/advertising-led-display-in-karnataka",
    label: "Karnataka",
    id: 103,
  },
  {
    href: "/advertising-led-display-in-tamil-nadu",
    label: "Tamil Nadu",
    id: 104,
  },
  { href: "/advertising-led-display-in-gujarat", label: "Gujarat", id: 105 },
  {
    href: "/advertising-led-display-in-delhi-ncr",
    label: "Delhi (NCR)",
    id: 106,
  },
  {
    href: "/advertising-led-display-in-telangana",
    label: "Telangana",
    id: 107,
  },
  {
    href: "/advertising-led-display-in-west-bengal",
    label: "West Bengal",
    id: 108,
  },
  {
    href: "/advertising-led-display-in-rajasthan",
    label: "Rajasthan",
    id: 109,
  },
